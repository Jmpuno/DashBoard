...
session_start();
    if(isset($_SESSION['welcomeMsg'])){
        ...
        window.location.href = "../view/Teacher/teacherDB.php";
        </script>'; 
...
<head>
  ...
  crossorigin="anonymous"></script>
    ...
    <a href="teacherRegistration.html" class="tRegister-button"><button type="button" class="trgstr-btn btn" href="teacherRegistration.html">Register Teacher Account</button></a>
